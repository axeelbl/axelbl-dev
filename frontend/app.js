const i18n = {
  es: {
    ...
    buttons: { viewAgents: 'Ver agentes', downloadCvEs: 'CV en español', downloadCvEn: 'CV en inglés', openAgent: 'Abrir' }, studioCta: { kicker: 'AI Agent Studio', title: 'Crea tu propio agente en segundos', copy: 'Construye una demo de agente personal con sector, herramientas, instrucciones, conversación, grafo de ejecución y modo técnico.', button: 'Crear mi agente' },
    strip: { aria: 'Áreas' },
