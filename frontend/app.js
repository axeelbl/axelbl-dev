const i18n = {
  ...
  ca: {
    ...
    work: { caseStudy: 'Llegir cas', website: 'Veure web', call: { kicker: 'IA en producció', title: 'Sistema d’anàlisi de trucades amb IA', copy: 'Treball professional desenvolupat des de MST Holding per a CaixaBank: pipeline end-to-end per transformar àudios reals en transcripcions, rutes i avaluacions automàtiques amb Whisper, LLMs locals i backend productiu on-premise.' }, callPartners: { aria: 'Projecte desenvolupat per a CaixaBank i MST Holding', label: 'Treball per a' }, callMetrics: { aria: 'Mètriques del sistema d’anàlisi de trucades', evaluatedAudio: 'àudios avaluats automàticament', peak: 'àudios per hora', pipeline: 'pipeline complet en producció', privateGpu: 'GPU local i dades privades' }, callHardware: 'On-premise · 2× NVIDIA RTX PRO 6000 Blackwell · Whisper · vLLM · FastAPI', gnn: { kicker: 'Recerca · Graph ML', title: 'Do We Need GNN Edge?', copy: 'Recerca experimental sobre quan les GNN aporten valor real davant MLPs i models lleugers per a predicció tèrmica en grafs.' }, framework: { kicker: 'Arquitectura LLM', title: 'Framework d’agents', copy: 'Framework modular per crear agents LLM locals reutilitzables.' }, lovelink: { kicker: 'Grafs / ML', copy: 'Sistema de recomanació basat en connexions socials indirectes.' }, dashboard: { kicker: 'Full stack', title: 'Dashboard financer', copy: 'Dashboard de finances personals amb Python, Flask i SQLite.' } },
