const i18n = {
  es: {
    ...
    buttons: { viewAgents: 'Ver agentes', downloadCv: 'Descargar CV', openAgent: 'Abrir' },
    strip: { aria: 'Áreas' },
    ...
    work: {
      caseStudy: 'Leer caso', website: 'Ver web', call: { kicker: 'IA en producción', title: 'Sistema de análisis de llamadas con IA', copy: 'Pipeline end-to-end para transformar audios reales en transcripciones, rutas y evaluaciones automáticas con Whisper, LLMs locales y backend productivo on-premise.' }, callMetrics: { aria: 'Métricas del sistema de análisis de llamadas', evaluatedAudio: 'audios evaluados automáticamente', peak: 'Audios x hora', pipeline: 'pipeline completo en producción', privateGpu: 'GPU local y datos privados' }, callHardware: 'On-premise · 2× NVIDIA RTX PRO 6000 Blackwell · Whisper · vLLM · FastAPI', framework: { kicker: 'Arquitectura LLM', title: 'Framework de agentes', copy: 'Framework modular para crear agentes LLM locales reutilizables.' }, lovelink: { kicker: 'Grafos / ML', copy: 'Sistema de recomendación basado en conexiones sociales indirectas.' }, dashboard: { kicker: 'Full stack', title: 'Dashboard financiero', copy: 'Dashboard de finanzas personales con Python, Flask y SQLite.' }
    },
  ...
  en: {
    ...
    buttons: { viewAgents: 'View agents', downloadCv: 'Download CV', openAgent: 'Open' }, strip: { aria: 'Areas' }, sections: { profile: '01 / Profile', experience: '02 / Experience', agents: '03 / AI Agents', work: '04 / Selected work', stack: '05 / Stack', credentials: '06 / Credentials', contact: '07 / Contact' },
    ...
    work: { caseStudy: 'Read case study', website: 'View website', call: { kicker: 'Production AI', title: 'AI call analysis system', copy: 'End-to-end pipeline that turns real audio into transcriptions, routing decisions and automated evaluations with Whisper, local LLMs and on-premise backend services.' }, callMetrics: { aria: 'AI call analysis system metrics', evaluatedAudio: 'audio files evaluated automatically', peak: 'audio files per hour', pipeline: 'complete production pipeline', privateGpu: 'local GPU and private data' }, callHardware: 'On-premise · 2× NVIDIA RTX PRO 6000 Blackwell · Whisper · vLLM · FastAPI', framework: { kicker: 'LLM Architecture', title: 'Agent framework', copy: 'Modular framework for building reusable local LLM agents.' }, lovelink: { kicker: 'Graphs / ML', copy: 'Recommendation system based on indirect social connections.' }, dashboard: { kicker: 'Full stack', title: 'Financial dashboard', copy: 'Personal finance dashboard with Python, Flask and SQLite.' } },
  ...
  ca: {
    ...
    buttons: { viewAgents: 'Veure agents', downloadCv: 'Descarregar CV', openAgent: 'Obrir' }, strip: { aria: 'Àrees' }, sections: { profile: '01 / Perfil', experience: '02 / Experiència', agents: '03 / Agents IA', work: '04 / Projectes destacats', stack: '05 / Stack', credentials: '06 / Credencials', contact: '07 / Contacte' },
    ...
    work: { caseStudy: 'Llegir cas', website: 'Veure web', call: { kicker: 'IA en producció', title: 'Sistema d’anàlisi de trucades amb IA', copy: 'Pipeline end-to-end per transformar àudios reals en transcripcions, rutes i avaluacions automàtiques amb Whisper, LLMs locals i backend productiu on-premise.' }, callMetrics: { aria: 'Mètriques del sistema d’anàlisi de trucades', evaluatedAudio: 'àudios avaluats automàticament', peak: 'àudios per hora', pipeline: 'pipeline complet en producció', privateGpu: 'GPU local i dades privades' }, callHardware: 'On-premise · 2× NVIDIA RTX PRO 6000 Blackwell · Whisper · vLLM · FastAPI', framework: { kicker: 'Arquitectura LLM', title: 'Framework d’agents', copy: 'Framework modular per crear agents LLM locals reutilitzables.' }, lovelink: { kicker: 'Grafs / ML', copy: 'Sistema de recomanació basat en connexions socials indirectes.' }, dashboard: { kicker: 'Full stack', title: 'Dashboard financer', copy: 'Dashboard de finances personals amb Python, Flask i SQLite.' } },
  ...
  no: {
    ...
    buttons: { viewAgents: 'Se agenter', downloadCv: 'Last ned CV', openAgent: 'Åpne' }, strip: { aria: 'Områder' }, sections: { profile: '01 / Profil', experience: '02 / Erfaring', agents: '03 / AI-agenter', work: '04 / Utvalgte prosjekter', stack: '05 / Stack', credentials: '06 / Credentials', contact: '07 / Kontakt' },
    ...
    work: { caseStudy: 'Les case study', website: 'Se nettside', call: { kicker: 'Produksjons-AI', title: 'AI-system for samtaleanalyse', copy: 'End-to-end pipeline som gjør ekte lyd om til transkripsjoner, ruting og automatiserte evalueringer med Whisper, lokale LLM-er og on-premise backend.' }, callMetrics: { aria: 'Metrikk for AI-system for samtaleanalyse', evaluatedAudio: 'lydfiler evaluert automatisk', peak: 'lydfiler per time', pipeline: 'komplett produksjonspipeline', privateGpu: 'lokal GPU og private data' }, callHardware: 'On-premise · 2× NVIDIA RTX PRO 6000 Blackwell · Whisper · vLLM · FastAPI', framework: { kicker: 'LLM-arkitektur', title: 'Agentrammeverk', copy: 'Modulært rammeverk for å bygge gjenbrukbare lokale LLM-agenter.' }, lovelink: { kicker: 'Grafer / ML', copy: 'Anbefalingssystem basert på indirekte sosiale forbindelser.' }, dashboard: { kicker: 'Full stack', title: 'Finansdashboard', copy: 'Dashboard for personlig økonomi med Python, Flask og SQLite.' } },
