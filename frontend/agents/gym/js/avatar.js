export class AvatarController {
    ...
    startBlinking() {
        setInterval(() => {
            ...
            this.baseFace.src = "/agents/gym/pictures/eyes_closed_mouth_closed.png";
            setTimeout(() => {
                this.baseFace.src = "/agents/gym/pictures/eyes_open_mouth_closed.png";
            }, 200);
        }, 4000);
    }
    ...
    startTalking() {
        ...
        this.avatarStatus.textContent = "Analizando tu mensaje";
    }
    ...
    stopTalking() {
        ...
        this.avatarStatus.textContent = "Coach online";
    }
}
